...
define('SELF_ROOT','http://www.sch.com/');
//define('SELF_ROOT','/');
...
return array(
    ...
    'weixin'=>array(
        ...
        'appid' =>'wxf6d4575db30565ce',			//微信appid
        'secret'=>'8ba5ecc78d50e8413f6d4ed4bc299c8b', //微信secret
         //微信支付ids
        'mchid' => '',
        'key' => '',

        //这里是异步通知页面url，提交到项目的Pay控制器的notifyurl方法；
        'notify_url'=>'http://www.sch.com/index.php/Api/Wxpay/notify',
